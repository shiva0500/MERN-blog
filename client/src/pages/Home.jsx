...
const Home = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="Homecontainer mx-auto my-8  lg:px-16">
        <h1 className="text-4xl font-bold mb-6 text-white text-center uppercase">
          Latest Posts
        </h1>
            ...
            <div
              ...
              {post.imageUrl && (
                <img
                  ...
                  alert('Error loading image', e.getMessage());}}
                />
              )}
